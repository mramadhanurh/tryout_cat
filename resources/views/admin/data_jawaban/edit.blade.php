...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="py-3 mb-3"><span class="text-muted fw-light">Edit Data</span> Jawaban</h4>
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-4">
                <div class="card-body">
                ...
                @endif
                    ...
                    <form action="{{ route('datajawaban.update') }}" method="POST">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <select name="question_id" class="form-control">
                                @foreach($soal as $sa)
                                    <option value="{{ $sa->id }}" {{ $data->question_id == $sa->id ? 'selected' : '' }}>{!! $sa->question_text !!}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="answer_text" id="answer" class="form-control" value="{{ $data->answer_text }}">
                        ...
                        <div class="mb-3">
                            ...
                            <!-- <textarea name="question_text" id="soal" class="form-control" cols="3" rows="6">{{ old('question_text') }}</textarea> -->
                            <input type="text" name="weight" id="weight" class="form-control" value="{{ $data->weight }}">
